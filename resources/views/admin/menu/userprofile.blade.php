...
<div class="row">
    <div class="col-xs-12">
                ...
                <div class="col-xs-12 col-sm-3 center">
                    <div>
                        <span class="profile-picture">
                            <img id="avatar" alt="{{Auth::user()->name}}" src="{{asset('images/'.Auth::user()->foto)}}" />
                            <div class="wordmiddle">
                                <a href="#{{Auth::user()->id}}-foto" data-toggle="modal" class="wordtext">Change</a>
                            </div>
                        </span>
                ...
                <div class="col-xs-12 col-sm-9">
                    <div class="center">
                        <span class="btn btn-app btn-sm btn-light no-hover">
                            <span class="line-height-1 bigger-170 blue"> {{$view}} </span>
                        ...
                        <span class="btn btn-app btn-sm btn-yellow no-hover">
                            <span class="line-height-1 bigger-170"> {{$article}} </span>
                    ...
                    <div class="profile-user-info profile-user-info-striped">
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                ...
                                <span class="editable" id="country">{{Auth::user()->lokasi}}</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span class="editable" id="age">{{Auth::user()->umur}}</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span class="editable" id="signup">{{date('j F Y',strtotime(Auth::user()->created_at))}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <br>
                    <div class="center">
                        <a href="#{{Auth::user()->id}}" data-toggle="modal" class="btn btn-success btn-md">Edit</a>
                    </div>
        ...
        <div class="modal fade" id="{{Auth::user()->id}}-foto">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('foto.update',Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            {{method_field('patch')}}
        ...
        <div class="modal fade" id="{{Auth::user()->id}}">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" area-hidden="true">&times;</button>
                    ...
                    <div class="modal-body">
                        <form action="{{route('users.update',Auth::user()->id)}}" method="post" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="location" value="{{Auth::user()->lokasi}}">
                            </div>
                            <div class="form-group">
                                <label>Age : </label>
                                <input type="text" class="form-control" name="age" value="{{Auth::user()->umur}}">
                            </div>
                            <div class="form-group">
                                <label>Email : </label>
                ...
                <div class="tab-content no-border padding-24">
                    <div id="home" class="tab-pane in active">
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 center">
                                <span class="profile-picture">
                                    <img alt="Alex's Avatar" id="avatar2" src="assets/images/avatars/profile-pic.jpg" />
                                </span>
