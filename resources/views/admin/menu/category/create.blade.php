    ...
    <div>
        <div class="col-md-10 col-md-offset-1">
            ...
            <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                ...
                <div class="modal fade" id="{{$cat1->id}}">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" area-hidden="true">&times;</button>
                            ...
                            <div class="modal-body">
                                <form action="{{route('category.update',$cat1->id)}}" method="post" role="form">
                                    {{csrf_field()}}
                                    {{method_field('put')}}
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="name" value="{{$cat1->name}}">
                                    </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="dataTables_info" id="dynamic-table_info" role="status" aria-live="polite">Showing {{$category->currentPage()}} of {{$category->lastPage() }} entries
                        </div>       
                    </div>
                    <div class="col-xs-6">
